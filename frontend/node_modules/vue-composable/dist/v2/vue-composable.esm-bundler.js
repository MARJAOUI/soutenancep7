import { isRef, ref, computed, set, watch, onMounted, toRaw, getCurrentInstance, onUnmounted, inject, reactive, unref, onActivated, onDeactivated, onBeforeUnmount, customRef, provide, watchEffect } from '@vue/composition-api';
import Vue from 'vue';
...
const vueDelete = (x, o) => Vue.delete(x, o);
const vueSet = set;
// FAKE readonly
function readonly(target) {
    return computed(() => unwrap(target));
}
...
}
{
    apiProxyFactory = (promiseApi) => {
        ...
        const proxyApi = {
            ...
            sendInspectorState(_) {
                queueEvent("sendInspectorState", arguments);
            },
            getComponentBounds(_) {
