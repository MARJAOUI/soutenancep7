...
export declare interface ClipboardItem {
    new (input: {
...
declare type DeepReadonly<T> = Readonly<T>;
 ...
 */
export declare function getDevtools(): DevtoolsPluginApi | undefined;
...
declare type Plugin_2 = PluginFunction<any>;
 ...
 * @param api
 */
export declare function setDevtools(app: VueConstructor, api: DevtoolsPluginApi): void;
...
export declare const UseDevtoolsApp: (app: VueConstructor, id?: string, label?: string) => void;
...
export declare const VueComposableDevtools: {
    install(app: VueConstructor, options?: {
        id: string;
        label: string;
    }): void;
};
