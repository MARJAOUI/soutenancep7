var vueComposableAxios = (function (exports, axios, runtimeCore) {
    'use strict';
    ...
    function makeAxios(client, throwException = false) {
        ...
        const cancelledMessage = runtimeCore.ref(null);
        ...
        const data = runtimeCore.computed(() => (use.result.value && use.result.value.data) ||
            (use.error.value &&
                use.error.value.response &&
                use.error.value.response.data) ||
            null);
        const status = runtimeCore.computed(() => (use.result.value && use.result.value.status) ||
            (use.error.value &&
                use.error.value.response &&
                use.error.value.response.status) ||
            null);
        const statusText = runtimeCore.computed(() => (use.result.value && use.result.value.statusText) ||
            (use.error.value &&
                use.error.value.response &&
